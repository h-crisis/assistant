 ...
 */
public class EarthquakeDamageDbCustomSet {
    private static String url;
    private static String usr;
    private static String pwd;

    public EarthquakeDamageDbCustomSet(String eventCode, String shelterCode) {
        // JDBCドライバのロード
        this.url = "jdbc:postgresql://gis.h-crisis.jp/hcrisis";
        this.usr = "hcrisis";
        this.pwd = "niph614";

        customSetEstimateInfoShelter2Table(eventCode, shelterCode);
    }

    public static void customSetEstimateInfoShelter2Table(String eventCode, String shelterCode) {
        try {
