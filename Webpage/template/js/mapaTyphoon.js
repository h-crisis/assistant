...
map.on('click', function(evt) {
    ...
    map.forEachFeatureAtPixel(pixel, function (feature) {
        ...
        labelHinan[0] = feature.get('S01');
        labelHinan[1] = feature.get('S02');
        labelHinan[2] = feature.get('S03');;
        labelHinan[3] = feature.get('S04');;
        labelHinan[4] = feature.get('S05');
    ...
    if (labelSelf == "noPlace") {
        ...
        */
        ...
        info.rows[2].cells[0].innerHTML = "市区町村名";
        info.rows[2].cells[1].innerHTML = labelHinan[2];
        info.rows[3].cells[0].innerHTML = "住所";
        info.rows[3].cells[1].innerHTML = labelHinan[3];
        info.rows[4].cells[0].innerHTML = "情報更新日時";
        info.rows[4].cells[1].innerHTML = labelHinan[4];
        /*
        for (i = 1; i < 16; i++){
