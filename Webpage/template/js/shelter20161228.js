...
var shelerTagId = ['a01','a01_1','a01_2','a02','a03','a04','a05','a06','a07','a08','a09','b02','b03','b03_1','b04','b04_1',
...
var shelterTagName = ['避難者数','避難者数(昼)','避難者数(夜)','電話','FAX','メールアドレス','施設の広さ','スペース密度','一人当たり専有面積',
...
var shelterBtnId = ['a01','a01_1','a01_2','a02','a03','a04','a05','a07','a08','a09','b02','b03_1','b04_1','b04_2','b04_3','b05_1','b05_2','b05_3','c01_7','c02_6_1','c02_7_1','c02_9',
    ...
    'c04_1','c04_2','c04_3'];
var evacueeTagId = ['d01','d01_1','d01_2','d02','d02_1','d03','d04','d05','d05_1','d05_2','d05_3','d06','d06_1', 'd06_2',
...
var evacueeTagName = ['高齢者','75歳以上','要介護認定高齢者','妊婦','うち妊婦健診受診困難者数','産婦','乳児','幼児・児童','身体障害児',
...
function createShelterInfoHtml(result) {
    ...
    if(typeof name === 'undefined') {
        ...
        for (i = 0; i < shelerTagId.length; i = i + 2) {
            poppedHtml = poppedHtml +  "<tr><th scope='row'>" + shelterTagName[i] + "</th><td>" + result.get(shelerTagId[i]) + "</td></tr>";
            if (i + 1 < shelerTagId.length) {
                poppedHtml = poppedHtml +  "<tr><th scope='row' class='even'>" + shelterTagName[i + 1] + "</th><td class='even'>" + result.get(shelerTagId[i + 1]) + "</td></tr>"
            }
        }
        for (i = 0; i < evacueeTagId.length; i = i + 2) {
            poppedHtml = poppedHtml +  "<tr><th scope='row'>" + evacueeTagName[i] + "</th><td>" + result.get(evacueeTagId[i]) + "</td></tr>";
            if (i + 1 < evacueeTagId.length) {
                poppedHtml = poppedHtml +  "<tr><th scope='row' class='even'>" + evacueeTagName[i + 1] + "</th><td class='even'>" + result.get(evacueeTagId[i + 1]) + "</td></tr>"
            }
        }
