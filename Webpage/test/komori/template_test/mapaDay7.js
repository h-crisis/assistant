...
map.on('click', function(evt) {
    ...
    if (labelSelf == "noPlace") {
        ...
        if (labelHosp[1] != "未") {
            infoH.innerHTML = infoH.innerHTML + "<tr><td style='font-size:20px; border:2px solid burlywood; background-color:#888888; text-align:center; table-layout:fixed; width: 380px' type=button ><a href=../../../template/mqtt/shelter-emergency.html style='display:block; width:100%; color:white; text-decoration:none' id=hospLonLatD target=_blank>詳細情報を閲覧</a></td></tr>";
