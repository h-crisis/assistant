...
map.on('click', function(evt) {
    ...
    if(labelSelf == "noPlace") {
        ...
        info.innerHTML = info.innerHTML + "<a href=../../../template/mqtt/shelter-emergency.html id=niphLonLat target=_blank>NIPH</a>" + "<br>";
        ...
        info.innerHTML = info.innerHTML +  "<div style='border:2px solid burlywood; background-color:#888888; text-align:center' type=button ><a href=../../../template/mqtt/shelter-emergency.html style='display:block; width:100%; color:white; text-decoration:none' id=niphLonLatE target=_blank>緊急時情報入力</a></div>";
        var niphAddressE=document.getElementById('niphLonLatE');
        niphAddressE.href='http://h-crisis.niph.go.jp/assistant/wp-content/uploads/sites/4/test/mqtt/shelter-emergency_2.html' + '?' + 'ID=' + labelC + ',Name=' + labelB + ',x=' + lon + ',y=' + lat;
        info.innerHTML = info.innerHTML +  "<div style='border:2px solid burlywood; background-color:#888888; text-align:center' type=button ><a href=../../../template/mqtt/shelter-emergency.html style='display:block; width:100%; color:white; text-decoration:none' id=niphLonLatH target=_blank>避難所シート(保健師長会式)を入力</a></div>";
        var niphAddressH=document.getElementById('niphLonLatH');
        niphAddressH.href='http://h-crisis.niph.go.jp/assistant/wp-content/uploads/sites/4/test/mqtt/shelter-hmethod.html' + '?' + 'ID=' + labelC + ',Name=' + labelB + ',x=' + lon + ',y=' + lat;
        info.innerHTML = info.innerHTML +  "<div style='border:2px solid burlywood; background-color:#888888; text-align:center' type=button ><a href=../../../template/mqtt/shelter-emergency.html style='display:block; width:100%; color:white; text-decoration:none' id=niphLonLatI target=_blank>避難所シート(石井式)を入力</a></div>";
        var niphAddressI=document.getElementById('niphLonLatI');
        niphAddressI.href='http://h-crisis.niph.go.jp/assistant/wp-content/uploads/sites/4/test/mqtt/shelter-imethod.html' + '?' + 'ID=' + labelC + ',Name=' + labelB + ',x=' + lon + ',y=' + lat;
        while (i < 15) {
            info.innerHTML = info.innerHTML + "<tr><td style=font-size:24px;background-color:#888888;color:white></td><td style=font-size:24px;background-color:white;text-align:right;></td></tr>";
            i++
        }
        ...
        info.innerHTML = "<div style='border:2px solid burlywood; background-color:#888888; color:white; text-align:center;' type=button id=showBtn value=隠す onclick=showHide()>閉じる</div>";
        info.innerHTML = info.innerHTML +  labelB;
        info.innerHTML = info.innerHTML +  "<div style='background-color:#888888; text-align:center' type=button ><a href=../../../template/mqtt/shelter-emergency.html style='display:block; width:100%; color:white; text-decoration:none' id=niphLonLat target=_blank>緊急時入力画面を開く</a></div>";
        var niphAddress=document.getElementById('niphLonLat');
