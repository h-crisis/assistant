...
var view = new ol.View({
    center: ol.proj.transform([137.578251, 34.552066], 'EPSG:4326', 'EPSG:3857'),
    zoom: 8,
    minZoom: 3,
    maxZoom: 15
});
...
document.getElementById('visible-hosp').style.backgroundColor = "blue";
map.addLayer(ImpassableLayer);
document.getElementById('visible-pass').style.backgroundColor = "red";
