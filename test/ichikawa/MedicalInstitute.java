...
public class MedicalInstitute {
    ...
    public static void plusMesh(String path) throws Exception {
        ...
        File mesh1st = new File("files/ShapeFiles/mesh/Mesh1st_Center.shp");
        File mesh2nd = new File("files/ShapeFiles/mesh/Mesh2nd_Center.shp");
        File mesh3rd = new File("files/ShapeFiles/mesh/Mesh3rd_Center.shp");
        File mesh4th = new File("files/ShapeFiles/mesh/Mesh4th_Center.shp");
        File mesh5th = new File("files/ShapeFiles/mesh/Mesh5th_Center.shp");
