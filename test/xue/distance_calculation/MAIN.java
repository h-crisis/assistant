...
public class MAIN {
    public static void main(String args[]) throws Exception {
        /*
        File Mesh2nd = new File("/Users/jiao/Desktop/shortestpath_test/Mesh2nd_2.csv");//2次メッシュコードファイル
        //File srcfilepath = new File("/Users/jiao/Desktop/split_map/全道路リンク.shp");//全道路リンク
        File shelter = new File("/Users/jiao/Desktop/shortestpath_test/5mesh_lat_lon_mesh.csv");//避難所（5thメッシュ、または病院などでもいい )の緯度経度とlocationの2次メッシュ　　　
        ...
        pw.write("5thmesh"+","+"ecode"+","+"distance");
        pw.close();
        ...
        while ((line = distance_info.readLine()) != null) {
          ...
          //  File shelter_temp = new File("/Users/jiao/Desktop/shortestpath_test/shelter_lat_lon_mesh_temp.csv");
           ...
           // new transShape(srcfilepath, destfilepath,value);//分割
            File destfilepath= new File("/Users/jiao/Desktop/split_map/out/" + value + "_fig.shp");
            //refile.select(shelter, shelter_temp, value);//2次メッシュコード内の避難所を抽出する
            File shelter_temp= new File("/Users/jiao/Desktop/split_map/2ndmesh_hospital/" + value + "_s.csv");
