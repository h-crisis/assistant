package DisasterHeadquatersSelect.ga.util;
/*
 ...
 * @author hmkz
 */
public class TMersenneTwister19937 extends Random {

	/**
	 * Auto-generated serial version UID.  Note that TMersenneTwister19937 does NOT
	...
	/**
	 * The default constructor for an instance of TMersenneTwister19937.  This invokes
	 ...
	 * @author David Beaumont
	 */
	public TMersenneTwister19937(boolean compatible) {
		super(0L);
		compat = compatible;
	 ...
	 * @author David Beaumont
	 */
	public TMersenneTwister19937(long seed) {
		super(seed);
	}
	 ...
	 * @author David Beaumont
	 */
	public TMersenneTwister19937(byte[] buf) {
		super(0L);
		setSeed(buf);
	}
	 ...
	 * @author David Beaumont
	 */
	public TMersenneTwister19937(int[] buf) {
		super(0L);
		setSeed(buf);
	}
	 ...
	 * is passed to two different instances of TMersenneTwister19937 (both of
	...
	protected final synchronized int next(int bits) {
		...
		if (mti >= N) {             // generate N words at one time
			...
			// Use the constructor TMersenneTwister19937(true) to enable backwards
