...
import DisasterHeadquatersSelect.ga.util.TComparator;
import DisasterHeadquatersSelect.ga.util.TMyRandom;
...
public class TUndx {
	...
	private void calcUnitVectorAndStandardDeviationForSecondaryComponent(TVector v1, TVector v3) {
		TVector v1v3 = new TVector(v3); // �e�P�Ɛe�R�����ԃx�N�g��
		v1v3.sub(v1);
		TVector tmp = new TVector(fEVector);
		tmp.scalarProduct(fEVector.innerProduct(v1v3));
		TVector perpendicular = new TVector(v1v3); // �e�R����e�P�Ɛe�Q�����Ԓ����։��낵�������x�N�g��
