package DisasterHeadquatersSelect.DMATArrange;

import com.google.common.base.StandardSystemProperty;
//import DisasterHeadquatersSelect.evaluator.SphereEvaluator;
import DisasterHeadquatersSelect.evaluator.DMATfirstEvaluator;
import DisasterHeadquatersSelect.ga.realcode.TRealNumberIndividual;
import DisasterHeadquatersSelect.ga.realcode.TUndxMgg;
...
public class TestfirstDMATPlace {
    ...
    public static void main(String args[]) throws Exception {
        ...
        File Medicalfacility = new File("test/xue/DisasterHeadquatersSelect/Medicalfacility.csv");
        File Medicallocation = new File("test/xue/DisasterHeadquatersSelect/Medicallocation.csv");
        File DMATlevel = new File("test/xue/DisasterHeadquatersSelect/DMATlevel.csv");
        File HeadQuater = new File("test/xue/DisasterHeadquatersSelect/DecideHospital/OutHeadQuater.csv");
        String str;
