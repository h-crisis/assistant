...
public class Decideheadquaters {
    ...
    public static void main(String args[]) throws Exception {
        ...
        File test = new File("test/iwasaki/hospital_info.csv");
    ...
    public static void pirntNumberofPatientrenge() {
        ...
        for (int i = 0; i < Totalrengecode.size(); ++i) {
            System.out.println("rengecode  " + Totalrengecode.get(i) + "  TotalNumberofpatient" + Numberofpatieninrenge.get(Totalrengecode.get(i)));
        }
    }

    public static void printHopitalCapacity() {
        for (int i = 0; i < Hospitalcode.size(); ++i) {
            System.out.println("rengecode " + rengeHopitalcode.get(i) + "  Hopitalcode " + Hospitalcode.get(i) + "  HopitalCpacity " + HospitalCapacity.get(rengeHopitalcapacity.get(i)));
        }
    }

    public static void printHopitalSeismic() {
        for (int i = 0; i < Hospitalcode.size(); ++i) {
            System.out.println("rengecode " + rengeHopitalcode.get(i) + "  Hopitalcode " + Hospitalcode.get(i) + "  HopitalSeismic " + HospitalSeismic.get(rengeHospitalseismic.get(i)));
        }
    ...
    public static void writeHeadquaterCandidate() throws Exception {
        ...
        //ファイル書き込みオブジェクトの作成
        File file = new File("test/iwasaki/OutHeadQuatercandidate.csv");

        PrintWriter pw = new PrintWriter(new OutputStreamWriter(new FileOutputStream(file, false), "UTF-8"));
        pw.write("renge,HospitalNumber,seismic,TotalNumberofpatientinrenge,Capacity,TotalCapacity,Hospitallan,Hospitallon");
    ...
    public static void writeHeadquater() throws Exception {
        ...
        //ファイル書き込みオブジェクトの作成
        File file = new File("test/iwasaki/OutHeadQuater.csv");
