/**
 * Created by komori on 2016/08/04.
 */
        ...
        if (feature.get('assist') == "要"){
            for (var i = 0; i < 16 ; i++) {
                if (biNum == i) {
                    ...
                    styleHospR[i].getText().setText(resolution < 40 ? feature.get('name') : '');
            ...
            for (var i = 0; i < 16 ; i++) {
                if (biNum == i) {
                    ...
                    styleHospG[i].getText().setText(resolution < 40 ? feature.get('name') : '');
            ...
            for (var i = 0; i < 16 ; i++) {
                if (biNum == i) {
                    ...
                    styleHospB[i].getText().setText(resolution < 40 ? feature.get('name') : '');
