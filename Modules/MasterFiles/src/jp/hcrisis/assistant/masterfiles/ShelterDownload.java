...
public class ShelterDownload {
    public static void main(String args[]) throws IOException {
        createShelterMasterYahoo(new File("file/shelter.csv"));
    }
     ...
     * @param file 出力ファイル
     */
    public static void createShelterMasterYahoo(File file) {
        try(PrintWriter pw = new PrintWriter(new OutputStreamWriter(new FileOutputStream(file, false), "Shift_JIS"))) {
            ...
            String[] prefecture_name = {
                    "北海道", "青森", "岩手県", "宮城県", "秋田県", "山形県", "福島県", "茨城県", "栃木県", "群馬県",
    ...
    public static String getColName() {
        return "都道府県,市区町村,避難所名,住所,緯度,経度,避難所,一時避難所,広域避難所,地震,風水害,津波,収容人数,備蓄品";
    }
    ...
    public static String getShelterData(Element shelter, String prefecture) {
        try {
            ...
            str = str + "," + shelter.getElementsByClass("autonomy").text(); // 自治体名
            str = str + "," + shelter.getElementsByClass("name").text(); // 避難所名
            str = str + "," + shelter.getElementsByClass("address").text(); // 住所
            ...
            str = str + "," + shelter.getElementsByClass("capacity").text(); // 収容人数
            str = str + "," + shelter.getElementsByClass("stock").text(); // 備蓄品
            return str;
        }
        catch (IOException e) {
            e.printStackTrace();
